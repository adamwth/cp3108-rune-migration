...
const img1_dir = 'beside(stack(sail_bb, sail_bb), stack(corner_bb, corner_bb))_ex2.png';
const img2_dir = 'stack(beside(sail_bb, corner_bb), beside(sail_bb, corner_bb))_ex2.png';
